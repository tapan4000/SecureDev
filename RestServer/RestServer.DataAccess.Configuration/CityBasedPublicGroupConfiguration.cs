...
{
    public class CityBasedPublicGroupConfiguration : EntityTypeConfiguration<CityBasedPublicGroup>
    {
        public CityBasedPublicGroupConfiguration()
        {
            // Primary Key
            this.HasKey(t => t.CityBasedPublicGroupId);

            // Properties
            this.ToTable("CityBasedPublicGroup");
            this.Property(t => t.CityBasedPublicGroupId)
