...
{
    public class EmergencySessionViewerConfiguration : EntityTypeConfiguration<EmergencySessionViewer>
    {
        public EmergencySessionViewerConfiguration()
        {
            // Primary Key
            this.HasKey(t => t.EmergencySessionViewerId);

            // Properties
            this.ToTable("EmergencySessionViewer");
            this.Property(t => t.EmergencySessionViewerId)
