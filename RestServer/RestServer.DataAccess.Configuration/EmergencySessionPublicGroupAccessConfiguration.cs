...
{
    public class EmergencySessionPublicGroupAccessConfiguration : EntityTypeConfiguration<EmergencySessionPublicGroupAccess>
    {
        public EmergencySessionPublicGroupAccessConfiguration()
        {
            // Primary Key
            this.HasKey(t => t.EmergencySessionPublicGroupAccessId);

            // Properties
            this.ToTable("EmergencySessionPublicGroupAccess");
            this.Property(t => t.EmergencySessionPublicGroupAccessId)
