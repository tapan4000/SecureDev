...
{
    public class CountryBasedPublicGroupConfiguration : EntityTypeConfiguration<CountryBasedPublicGroup>
    {
        public CountryBasedPublicGroupConfiguration()
        {
            // Primary Key
            this.HasKey(t => t.CountryBasedPublicGroupId);

            // Properties
            this.ToTable("CountryBasedPublicGroup");
            this.Property(t => t.CountryBasedPublicGroupId)
